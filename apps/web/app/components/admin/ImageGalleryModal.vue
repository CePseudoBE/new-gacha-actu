      ...
      <div class="flex-1 overflow-y-auto">
        ...
        <div v-else class="space-y-4">
          ...
          <div
            ...
            :class="{
              'border-primary ring-2 ring-primary': selectedImageId === image.id,
              'border-transparent hover:border-muted-foreground': selectedImageId !== image.id,
            }"
        ...
        <div v-if="selectedImage" class="mt-6 p-4 border rounded-lg space-y-4">
          ...
          <div class="space-y-2">
            <Label for="altText" class="text-sm font-medium">
              Texte alternatif
              <span class="text-muted-foreground font-normal">(pour l'accessibilité et le SEO)</span>
            </Label>
            <Input
              id="altText"
              v-model="altText"
          ...
          <div class="p-3 bg-muted rounded-lg">
            <p class="text-sm text-muted-foreground mb-1">Sera inséré comme :</p>
            <code class="text-sm font-mono">![{{ altText || 'Image' }}]({{ selectedImage.url }})</code>
          </div>
        </div>
      </div>
...
import { Check, Plus, Trash2, Loader2, ImageIcon } from 'lucide-vue-next'
