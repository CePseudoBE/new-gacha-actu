...
export default class SeoKeywordsController {
  ...
  async index(ctx: HttpContext) {
    ...
    return ResponseService.ok(ctx, seoKeywords)
  }
  ...
  async show(ctx: HttpContext) {
    ...
    return ResponseService.ok(ctx, seoKeyword)
  }
  ...
  async store(ctx: HttpContext) {
    ...
    return ResponseService.created(ctx, seoKeyword, 'Mot-clé SEO créé avec succès')
  }
  ...
  async update(ctx: HttpContext) {
    ...
    return ResponseService.ok(ctx, seoKeyword, 'Mot-clé SEO mis à jour avec succès')
  }

  async destroy(ctx: HttpContext) {
    const { params: validatedParams } = await ctx.request.validateUsing(seoKeywordParamsValidator)
    await this.seoKeywordService.deleteSeoKeyword(validatedParams.id)
    return ResponseService.success(ctx, 'Mot-clé SEO supprimé avec succès')
  }
}
